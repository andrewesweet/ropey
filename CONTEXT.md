...
_Avoid_: hit, occurrence (occurrence is reserved for reference-finding in Refactorings), proven (overclaims — nothing in a Rewrite is tool-proven; only constraint satisfaction is established).
